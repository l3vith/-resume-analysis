    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <video
          ...
          playsInline
        />
        {/* subtle color overlay for contrast */}
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/60 via-purple-900/50 to-pink-800/60 pointer-events-none"></div>

        {/* decorative overlays (kept but toned down) */}
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-pulse animation-delay-2000"></div>
        <div className="absolute top-40 left-1/2 w-80 h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-pulse animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Get instant ATS scoring and actionable insights to make your resume
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-lg">
                    Drop your text file, PDF, or Word document here, or click to
                    browse
                  </p>
                </div>
              ...
              {!import.meta.env.VITE_GEMINI_API_KEY && (
                <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                  <p className="text-yellow-400 text-sm">
                    <strong>Setup Required:</strong> Please add your Gemini API
                    key to the .env file to enable resume analysis.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 text-center">
              ...
              <p className="text-white/70 mb-6">
                Gemini AI is analyzing your resume for ATS compatibility,
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                {Object.entries(results.breakdown).map(([category, score]) => (
                  ...
                  >
                    <div
                      className={`text-2xl font-bold ${getScoreColor(score)} mb-1`}
                    >
                      {score}%
                    </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {results.improvements.critical.map(
                        (improvement, index) => (
                          <li
                            key={index}
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {results.improvements.important.map(
                        (improvement, index) => (
                          <li
                            key={index}
                            className="text-white/80 text-sm flex items-start gap-2"
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {results.improvements.suggested.map(
                        (improvement, index) => (
                          <li
                            key={index}
                            className="text-white/80 text-sm flex items-start gap-2"
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6">
                ...
                <div className="mt-8 p-4 bg-green-500/10 rounded-lg border border-green-500/20">
                  ...
                  <p className="text-white/80 text-sm">
                    Build on these strengths while addressing the critical
                    issues to significantly improve your ATS score.
                  </p>
                </div>
              </div>
            </div>
